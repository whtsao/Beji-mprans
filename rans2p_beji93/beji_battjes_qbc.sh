...
#. ~/.bashrc
mkdir -p $WORK/beji_battjes.$SLURM_JOBID
cd $WORK/beji_battjes.$SLURM_JOBID 
...
srun -N2 -n48 -c1 parun beji_battjes_so.py -l 5 -C "he=0.006 T=60.0 free_slip=True" -O petsc.options.superlu_dist
